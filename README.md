...
- **Архів сесій**: «Новий аналіз» зберігає поточну сесію в архів; будь-яку можна відкрити знову. «Форма гравців» показує BPR кожного по сесіях (гравців зіставлено за акаунтом, тож зміна ніку не заважає). Бекап архіву — у файл і назад.
