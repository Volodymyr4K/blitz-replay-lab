...
const en = {
  ...
  archiveIntro:
    'Sessions are saved in this browser. “New analysis” files the current session here automatically. Export a backup to keep them safe or to move them to another device.',
  archiveEmpty: 'No saved sessions yet. Analyze some replays — they land here when you start a new analysis or press “Save to archive”.',
  archiveSave: 'Save to archive',
  archiveSaved: 'Saved to archive',
  archiveFailed: 'Could not save to the archive — browser storage may be full or disabled. Nothing was cleared.',
  archiveClearedSaved: 'Session saved to the archive and cleared',
  archiveOpen: 'Open',
  archiveOpened: 'Opened “{title}”',
  archiveDelete: 'Delete',
  archiveDeleted: 'Deleted “{title}”',
  archiveCurrent: 'open now',
  fromArchive: 'in archive',
  fromArchiveHint: 'This session is saved in the archive. New replays and edits go into the same saved session; “New analysis” starts a separate one.',
  archiveVsClan: 'vs [{clan}]',
  archiveExport: 'Export backup',
  archiveImport: 'Import backup',
  archiveImported: { one: 'Imported {n} session', other: 'Imported {n} sessions' },
  archiveImportSkipped: 'Already in the archive: {n}',
  archiveImportInvalid: 'Skipped as damaged: {n}',
  archiveBadFile: 'This file is not a Blitz Replay Lab backup',
  archiveSessionsTab: 'Sessions',
  archiveFormTab: 'Player form',
  sessionsN: { one: '{n} session', other: '{n} sessions' },
  formIntro: 'Our side across every saved session, matched by account, so renamed players stay one line. Change compares the last two sessions.',
  formRegularsOnly: 'Only players with 2+ sessions',
  formNoRegulars: 'Nobody has played in two saved sessions yet — untick the filter to see everyone.',
  formEmpty: 'Save a couple of sessions to see how each player’s form changes.',
  ...
  privacyBody2:
    'The current session (parsed battle results, roster, language) is kept in your browser’s storage (IndexedDB) so it survives a reload and stays in sync across open tabs. “New analysis” moves it to the session archive, which lives in the same browser storage; deleting from the archive removes it for good. Browsers may clear site data after long inactivity (Safari: about 7 days), so export an archive backup, share or download anything you want to keep.',
  privacyHosting:
...
const uk: Dict = {
  ...
  navArchive: 'Архів',
  archiveTitle: 'Архів сесій',
  archiveIntro:
    'Сесії зберігаються в цьому браузері. «Новий аналіз» автоматично відправляє поточну сесію сюди. Зроби бекап, щоб не втратити їх або перенести на інший пристрій.',
  archiveEmpty: 'Поки що порожньо. Проаналізуй реплеї — сесія потрапить сюди, коли почнеш новий аналіз або натиснеш «В архів».',
  archiveSave: 'В архів',
  archiveSaved: 'Збережено в архів',
  archiveFailed: 'Не вдалося зберегти в архів — сховище браузера заповнене або вимкнене. Нічого не очищено.',
  archiveClearedSaved: 'Сесію збережено в архів і очищено',
  archiveOpen: 'Відкрити',
  archiveOpened: 'Відкрито «{title}»',
  archiveDelete: 'Видалити',
  archiveDeleted: 'Видалено «{title}»',
  archiveCurrent: 'відкрито зараз',
  fromArchive: 'в архіві',
  fromArchiveHint: 'Ця сесія збережена в архіві. Нові реплеї й зміни потрапляють у ту саму збережену сесію; «Новий аналіз» починає окрему.',
  archiveVsClan: 'проти [{clan}]',
  archiveExport: 'Експорт (бекап)',
  archiveImport: 'Імпорт бекапу',
  archiveImported: { one: 'Імпортовано {n} сесію', few: 'Імпортовано {n} сесії', many: 'Імпортовано {n} сесій', other: 'Імпортовано {n} сесії' },
  archiveImportSkipped: 'Уже були в архіві: {n}',
  archiveImportInvalid: 'Пропущено пошкоджених: {n}',
  archiveBadFile: 'Це не файл бекапу Blitz Replay Lab',
  archiveSessionsTab: 'Сесії',
  archiveFormTab: 'Форма гравців',
  sessionsN: { one: '{n} сесія', few: '{n} сесії', many: '{n} сесій', other: '{n} сесії' },
  formIntro: 'Наша сторона в усіх збережених сесіях. Гравці зіставляються за акаунтом, тож після зміни ніку це той самий рядок. «Зміна» порівнює дві останні сесії.',
  formRegularsOnly: 'Лише гравці з 2+ сесіями',
  formNoRegulars: 'Поки ніхто не грав у двох збережених сесіях — зніми фільтр, щоб побачити всіх.',
  formEmpty: 'Збережи хоча б дві сесії, щоб побачити, як змінюється форма гравців.',
  colSessions: 'Сесії',
  colLast: 'Остання сесія',
  colChange: 'Зміна',
  colTrend: 'Динаміка',
  ...
  privacyBody2:
    'Поточна сесія (розібрані результати боїв, склад, мова) зберігається в сховищі браузера (IndexedDB), щоб пережити перезавантаження, і синхронізується між відкритими вкладками. «Новий аналіз» переносить її в архів сесій, який лежить у тому ж сховищі браузера; видалення з архіву прибирає її остаточно. Браузери можуть очищати дані сайтів після тривалої неактивності (Safari — приблизно через 7 днів), тож роби бекап архіву, поширюй посиланням або вивантажуй те, що хочеш зберегти.',
  privacyHosting:
